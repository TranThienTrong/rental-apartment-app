...
public class Property {
    ...
    public Bedrooms getBedroom() {
        return bedroom;
    }

    public void setBedroom(Bedrooms bedroom) {
    ...
    public Property(int id, byte[] image, String title, int roomsQuantity, String price, String desc, String address, Bedrooms bedroomType, FurnitureTypes furnitureType, PropertyTypes propertyType) {
        this.id = id;
        this.image = image;
        this.title = title;
        this.roomsQuantity = roomsQuantity;

...
import com.example.rentalapartmentapp.Model.Bedrooms;
...
import com.example.rentalapartmentapp.View.Activities.BaseActivity;
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                Property property = new Property(
                        ...
                        Bedrooms.getBedroom(cursor.getString(cursor.getColumnIndex("bedroom"))),
